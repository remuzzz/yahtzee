...
class YahtzeeSpel {
	...
	void spelen() {
		System.out.println("Welkom bij Yahtzee. Je mag vijf keer achter elkaar gooien en hebt gewonnen als alle vijf de dobbelstenen hetzelfde zijn. ");
